...
type GetAllCourierRequest struct {
	...
	Radius    *string `form:"radius" binding:"omitempty,numeric,gte=0"`
	PerPage   *string `form:"per_page" binding:"omitempty,numeric,gte=1"`
	Page      *string `form:"page" binding:"omitempty,numeric,gte=1"`
